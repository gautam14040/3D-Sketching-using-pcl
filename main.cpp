        ...
        if(update)
        {
            ...
            for (int i = 0 ; i < 5; i++) {
                for (int j = 0; j < 4; j++) {
                    ...
                    viewer->removeShape(string("cube"));
                    viewer->addCube (bmin.x, bmax.x, bmin.y, bmax.y , bmin.z , bmax.z , 255 , 0 , 0 /*R,G,B*/,"cube");
                }
            }
            update = false;
        }
...
{
    viewer->addCube (bmin.x, bmax.x, bmin.y, bmax.y , bmin.z , bmax.z , 255 , 0 , 0 /*R,G,B*/,"cube");
    viewer->setShapeRenderingProperties (pcl::visualization::PCL_VISUALIZER_COLOR, 0.9, 0.1, 0.1 /*R,G,B*/, "cube", 0);
    viewer->setShapeRenderingProperties (pcl::visualization::PCL_VISUALIZER_OPACITY, 1, "cube", 0);
